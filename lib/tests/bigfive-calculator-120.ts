...
// 120問版の設問セット
const bigFiveQuestions = bigFiveQuestions120

/**
 * Big Five診断結果を計算する（120問版）
 *
 * スコア計算方法:
 ...
 *
 * 参考: BigFive OSS (MIT License)
 * https://github.com/Alheimsins/bigfive-web
 */
export function calculateBigFiveResult120(answers: BigFiveAnswer[]): BigFiveResult {
  // 質問データのマップ作成
